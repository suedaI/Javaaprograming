...
public class RelationalOperators {
    public static void main(String[] args) {
        ...
        boolean result2 = 305 >= 150; //one of them true ,make true
...
//credit score of 720
        int creditScore = 745;
        boolean isEligibleForLoan = creditScore >= 720;//if the creat score is 720 or greater,then it's eligible or not
